"""Gnina docking implementation (stub)."""
...
class GninaDocker(BaseDocker):
    """Gnina docking method (stub)."""
    ...
    def preprocess(self, protein_dir: Path, ligand_dir: Path):
        """Preprocess files for Gnina."""
        print("  Gnina preprocessing: STUB - Not implemented yet")
    
    def dock_all(self, ligand_dir: Optional[Path] = None):
        """Run Gnina docking."""
        print("  Gnina docking: STUB - Not implemented yet")
    
    def extract_metrics(self) -> List[Dict]:
        """Extract metrics from Gnina results."""
        print("  Gnina metrics extraction: STUB - Not implemented yet")
        return []
