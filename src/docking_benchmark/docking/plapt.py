"""PLAPT docking implementation (stub)."""
...
class PLAPTDocker(BaseDocker):
    """PLAPT docking method (stub)."""
    ...
    def preprocess(self, protein_dir: Path, ligand_dir: Path):
        """Preprocess files for PLAPT."""
        print("  PLAPT preprocessing: STUB - Not implemented yet")
    
    def dock_all(self, ligand_dir: Optional[Path] = None):
        """Run PLAPT docking."""
        print("  PLAPT docking: STUB - Not implemented yet")
    
    def extract_metrics(self) -> List[Dict]:
        """Extract metrics from PLAPT results."""
        print("  PLAPT metrics extraction: STUB - Not implemented yet")
        return []
